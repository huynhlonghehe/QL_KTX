...
<body>
    ...
    <div class="main_content">
        ...
        <div class="search-and-buttons">
            ...
            <button type="button" class="btn btn-primary button_createTK" onclick="window.location.href='http://localhost:8080/quan_ly_ktx/hoadondien/list'">
        ...
        <div id="createHDDForm" style="display: none">
            ...
            <form action="${pageContext.request.contextPath}/hoadondien/add-hdd" method="POST" onsubmit="return validateCreateHDDForm()">
                ...
                <div class="form-group">
                    <label for="add_maPhong" class="form-label">Mã Phòng:</label>
                    <input type="text" class="form-control" id="add_maPhong" name="maPhong" placeholder="Nhập mã phòng" required>
                </div>
        ...
        <div id="editHDDForm" style="display: none">
            ...
            <form id="editHDDFormDetails" action="${pageContext.request.contextPath}/hoadondien/edit-hdd" method="POST" onsubmit="return validateEditHDDForm()">
                ...
                <div class="form-group">
                    <label for="edit_maPhong" class="form-label">Mã Phòng:</label>
                    <input type="text" class="form-control" id="edit_maPhong" name="maPhong" required>
                </div>
