...
<style>
	...
	.four_zero_four_bg{
	 background-image: url(https://cdn.dribbble.com/users/285475/screenshots/2083086/dribbble_1.gif); /* assets/img/error404.gif */
	    height: 400px;
...
<body>
	...
	<section class="page_404">
	  <div class="container">
	    ...
	    <h3 class="h2">
	    Rất tiếc, nội dung này không tồn tại, hoặc đã được thay đổi.
